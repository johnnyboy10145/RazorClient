...
if ($releaseBuild) {
    ...
    $proguardLines = @(
        ...
        '-keep class com.razorclient.inject.JarSignatureVerifier { public static boolean verify(...); }',
        '-keep class com.razorclient.inject.ChildFirstPayloadLoader { *; }',
        '-keep class com.razorclient.runtime.SecureStringTable { *; }',
